    ...
    <div id="breadcrumb">
      <nav aria-label="breadcrumb" role="navigation">
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Disertante</li>
          </ol>
      </nav>
    </div>
  </article>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h6>Desea continuar con la Eliminaci&oacute;n del Disertante?</h6>
      </div>
...
<div class="modal fade" id="confirmarEliminarTodosModal" tabindex="-1" aria-labelledby="confirmarModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h6>Desea continuar con la Eliminaci&oacute;n de los Disertantes seleccionados?</h6>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
...
<div class="modal fade" id="sinElementosModal" tabindex="-1" aria-labelledby="confirmarModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h6>No ha seleccionado ningún Disertante.</h6>
      </div>
      <div class="modal-footer">
...
<!-- JAVASCRIPT CUSTOM -->
<script src="./js/disertante.js"></script>
